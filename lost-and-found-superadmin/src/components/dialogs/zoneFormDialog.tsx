...
export function ZoneFormDialog({
  ...
  const { data: zonesData, isLoading: isZonesLoading } = useGetZones(
    selectedCollegeId
      ? { collegeId: selectedCollegeId, isActive: true }
      : undefined,
  );
  ...
  useEffect(() => {
    if (open && zone) {
      ...
      setSelectedCollegeId(zone.collegeId?._id || "");
      setMapPosition(
      ...
      <DialogContent className="max-h-[90vh] max-w-3xl overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            {isEditMode && zone?.collegeId ? (
              <Input
                value={zone.collegeId.name}
                disabled
              ...
              <Select
                ...
                disabled={isSubmitting || isCollegesLoading}
              >
            ...
            {!selectedCollegeId && !isEditMode && (
              <p className="text-xs text-red-500">Please select a college</p>
            )}
          </div>
          ...
          <div className="flex gap-3 border-t pt-4">
            ...
            <Button
              ...
              disabled={isSubmitting || (!isEditMode && !selectedCollegeId)}
            >
              {isSubmitting ? (
                <>
