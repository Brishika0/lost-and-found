...
import { lostItemColumns } from "@/components/columns/lostItemColumns";
...
export default function PostsPage() {
  ...
  useEffect(() => {
    setSelectedCollegeId(collegesData?.data[0]._id);
  }, [isCollegeLoading]);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage all lost and found items reported in all the colleges. Filter
            by college to see different colleges
          </p>
        </div>
      </div>
