...
export default function StatsDashboard() {
  ...
  const { data: collegesStats, isLoading: collegesLoading } =
    useCollegesStats();
  ...
  return (
    <div className="min-h-screen">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-4 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              {isSuperAdmin
                ? "Overview of all colleges and platform activity"
        ...
        {/* Super Admin: Colleges Overview Section */}
        {isSuperAdmin && collegesStats?.data && (
          <div className="mb-4">
            <h2 className="mb-4 text-lg font-semibold">🏛️ Colleges Overview</h2>
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <StatCard
                title="Total Colleges"
                value={collegesStats.data.summary.totalColleges}
              ...
              <StatCard
                ...
                value={collegesStats.data.summary.totalStudents}
              ...
              <StatCard
                title="Total Items"
                value={collegesStats.data.summary.totalItems}
              ...
              <StatCard
                title="Total Zones"
                value={collegesStats.data.summary.totalZones}
        ...
        <Tabs defaultValue="items" className="mt-8">
          ...
          <TabsContent value="users" className="mt-6 space-y-6">
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              {/* Super Admin: Colleges Breakdown */}
              {isSuperAdmin && usersStats?.data.usersByCollege && (
                <ChartCard title="Users by College">
                  <ResponsiveContainer width="100%" height={300}>
                    <BarChart data={usersStats.data.usersByCollege}>
                      <CartesianGrid strokeDasharray="3 3" />
                      <XAxis dataKey="_id" />
                      <YAxis />
                      <Tooltip />
