...
export const AssignAdminDialog = ({
  ...
  const { data: adminsData, isLoading: isLoadingAdmins } = useGetCollegeAdmins({
    page: 1,
    limit: 100,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("Submitting assign admin form with:", {
      ...
      <DialogContent className="sm:max-w-[500px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Assign an admin to handle this dispute. The admin will be notified
              and can start reviewing the case.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            {selectedAdmin && !isLoadingAdmins && (
              <div className="rounded-lg border p-3">
                <p className="mb-2 text-sm font-medium">Selected Admin</p>
          ...
          <DialogFooter>
            ...
            <Button
              type="submit"
              disabled={!selectedAdminId || isPending || admins.length === 0}
            >
