...
export function CreateCouponDialog({
  ...
  const getFieldsForCurrentTab = () => {
    switch (activeTab) {
      case "basic":
        return ["couponType", "title", "description"];
      case "discount":
        return [
          "discountType",
          "discountValue",
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          >
            ...
            <TabsContent value="basic" className="mt-4 space-y-4">
              {/* College Selection - Auto-set from logged-in user */}
              ...
              <Field orientation="vertical" className="gap-0 space-y-0.5">
                <FieldGroup className="gap-0 space-y-1">
                  ...
                  <div className="h-10 rounded-md border bg-gray-50 px-3 py-2 text-sm">
                    {user?.college?.id ? user.college.name : "Loading..."}
                  </div>
                </FieldGroup>
              </Field>
