...
//       // Step 1 — create conversation in your DB + TalkJS (backend handles TalkJS sync)
...
//       // Step 2 — also register in TalkJS client-side session
//       // (keeps the ConversationList in sync immediately without page reload)
...
//       // Step 3 — send the claim message via backend (never expose secret key on frontend)
//       if (prefilledMessage) {
...
//       // Step 4 — navigate to chat with conversation pre-selected
